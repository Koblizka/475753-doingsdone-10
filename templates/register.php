      ...
      <div class="content">
        ...
        <main class="content__main">
          ...
          <form class="form" action="register.php" method="post" autocomplete="off">
            ...
            <?php $error = isset($errors["email"]) ? "form__input--error" : "";?>
              <input class="form__input <?=$error?>" type="text" name="email" id="email" value="<?=get_post_val("email")?>" placeholder="Введите e-mail">
            ...
            <div class="form__row">
              ...
              <?php $error = isset($errors["password"]) ? "form__input--error" : "";?>    
            ...
            <div class="form__row">
              ...
              <?php $error = isset($errors["email"]) ? "form__input--error" : "";?>
              <input class="form__input" type="text" name="name" id="name" value="<?=get_post_val("name")?>" placeholder="Введите логин">
